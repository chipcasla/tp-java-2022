...
<% 
String myServlet = request.getAttribute("servlet")==null?"controllerAdmin?option=main":(String)request.getAttribute("servlet");
%>
...
<body style="background-color: #07393b">
	<div class="bg-light"
		...
		<form action="AgregarAlumno" method="post" style="padding: 15px">
			<div class="form-row">
				<div>
			...
			<div class="form-row">
				...
				<div class="col-md-4 mb-3">
					<label for="validationDefault01">Nombre</label> <input type="text"
						value="" class="form-control" id="validationDefault01"
						name="first-name" required placeholder="Nombre">
				</div>
				<div class="col-md-3 mb-3">
					<label for="validationDefault02">Apellido</label> <input
						type="text" value="" class="form-control" id="validationDefault02"
			...
			<div class="form-row">
				<div class="col-md-4 mb-3">
					<label for="validationDefault03">Nro. Documento</label> <input
						...
						class="form-control" id="validationDefault03" name="dni" value=""
				...
				<div class="col-md-3 mb-3">
					<label for="validationDefault04">Teléfono</label> <input type="tel"
						...
						onchange="try{setCustomValidity('')}catch(e){}"
						class="form-control" id="validationDefault04" name="tel" value=""
						required placeholder="Teléfono">
				</div>
				<div class="col-md-3 mb-3 form-date">
					<label class="form-date__label" for="input-date">Fecha de
						nacimiento</label> <input class="form-control form-date__input" value=""
						type="date" id="input-date" max="<%=LocalDate.now()%>"
						name="date-birth" required />
				</div>
				<div class="col-md-3 mb-3">
					<label for="pass_word">Contraseña</label> <input type="password"
						pattern="^(?=\w*\d)(?=\w*[a-z])\S{3,16}$"
						oninvalid="setCustomValidity('Asegure que la contraseña tenga:\n - mínimo 3 caracteres\n - una letra\n - un número')"
						onchange="try{setCustomValidity('')}catch(e){}"
						class="form-control" id="pass_word" name="password" value=""

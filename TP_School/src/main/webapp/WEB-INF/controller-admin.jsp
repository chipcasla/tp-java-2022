...
%>
			...
			<div class="js-fullheight colorlib-table"
				...
				<div class="colorlib-table-cell js-fullheight"
					...
					<div class="contenedor bg-info row no-gutters">
						<div class="bg-light hijo text-center p-4 rounded-5"
							style="border-radius: 15px; width: 28rem; background-color: #07393b">
							<h1 class="mb-4">MENÚ DE OPCIONES</h1>
							<ul>
								<li class="active"><a href="<%= request.getContextPath()%>/Admin/controllerAdmin?option=main"><span>Home</span></a></li>
								<li><a href="<%= request.getContextPath()%>/Admin/controllerAdmin?option=stlist" style="color: #000"><span
										style="color: #000">Gestión Alumnos</span></a></li>
								<li><a href="<%= request.getContextPath()%>/Admin/controllerAdmin?option=profesores"><span
										style="color: #000">Gestión Profesores</span></a></li>
								<li><a href="<%= request.getContextPath()%>/Admin/controllerAdmin?option=cursos"><span
										style="color: #000">Cursos y Materias</span></a></li>
								<li><a href="<%= request.getContextPath()%>/Logout"><span style="color: #000">Cerrar
											sesión</span></a></li>
							</ul>
						</div>
					</div>
				...
				<div class="container px-0">
					<div
						...
						<% } %>
							<div class="desc">
								<h1>BIENVENIDO</h1>
								<h2 class="h3" style= "margin-top: 25px; margin-bottom: -8px;color: #ff5656">Colegio</h2>
								<h3 style= "font-size: 3rem;color: #ff5656"><%=p.getNombre()+" "+p.getApellido()%></h3>								
							</div>
						</div>
					</div>
				</div>
	...
	<script src="<%= request.getContextPath()%>/style/popper.js"></script>
	<script src="<%= request.getContextPath()%>/style/bootstrapmin.js"></script>
	<script src="<%= request.getContextPath()%>/style/main.js"></script>
	<script defer

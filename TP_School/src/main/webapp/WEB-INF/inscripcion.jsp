...
<select id="cur" name="cur" required class="form-select" onchange="cargaModalidad();" aria-label="Select course">
  ...
  <% for(Curso cur : lc) { %>
  <option value="<%=cur.getNombre()%>"><%=cur.getNombre()%> año</option>
  <% } %>
</select>
</div>
<div class="col-md-4 mb-3">
<label for="mod">Modalidad</label>
<select id="mod" name="mod" required class="form-select" aria-label="Select mod">
...
<span><i class="fa fa-plus"></i></span> Aceptar</button>

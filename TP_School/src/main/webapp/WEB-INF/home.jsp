				...
				<div class="colorlib-table-cell js-fullheight"
					...
					<div class="contenedor bg-info row no-gutters">
						<div class="bg-light hijo text-center p-4 rounded-5"
							...
							<ul>
								<li class="active"><a href="Alumno?opcion=home"><span>Home</span></a></li>
								<li><a href="Alumno?opcion=boletin" style="color: #000"><span
										style="color: #000">Boletín online</span></a></li>
								<li><a href="Alumno?opcion=inscripciones"><span
										style="color: #000">Inscripciones</span></a></li>
								<li><a href="Alumno?opcion=editar"><span
										style="color: #000">Editar mis datos</span></a></li>
								<li><a href="Logout"><span style="color: #000">Cerrar
											sesión</span></a></li>
							</ul>
						</div>
					</div>
				...
				<div class="container px-0">
					<div
						...
						<% } %>
							<div class="desc">
								<h1>BIENVENIDO</h1>
								<h2 class="h3" style= "color: tomato"><%=a.getNombre()+" "+a.getApellido()%></h2>
							</div>
						</div>
					</div>
				</div>

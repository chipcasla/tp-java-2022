			...
			<form class="form-signin" action="signin" method="post">
				<div>
					<svg xmlns="http://www.w3.org/2000/svg" width="56" height="56"
						fill="#07393b" class="bi bi-person-circle" viewBox="0 0 16 16">
				...
				<label for="inputEmail" class="sr-only">Dirección de correo
					electrónico</label> <input type="email" id="inputEmail" name="email"
					class="form-control" placeholder="Correo electrónico" required
					autofocus> <label for="inputPassword" class="sr-only">Contraseña</label>
				<input type="password" id="inputPassword" name="password"
					class="form-control" placeholder="Constraseña" required>
				<button class="w-100 btn btn-lg btn-primary btn-block" type="submit"
					style="background-color: #07393b">
					<span><i class="fa fa-sign-in"></i></span> Ingresar
				</button>
			</form>
		</div>
		<footer class="footer">
